...
class Config:
    ...
    # Main domain for multi-tenant; subdomains are tenant orgs (e.g. acme.trainingtracker.me).
    MAIN_DOMAIN = os.environ.get('MAIN_DOMAIN') or os.environ.get('SERVER_NAME') or 'trainingtracker.me'
